...
def _build_practices_reflection(data: CanonicalReportData, styles) -> List:
    ...
    if data.is_v2 and data.practices_v2:
        ...
        # Render reflection guidance (generated by LLM)
        if data.practices_v2.reflection_guidance:
            ...
            # Default fallback guidance if LLM didn't provide one
            elements.append(Spacer(1, 0.15*inch))
            elements.append(Paragraph(
                "<b>Reflection & Guidance:</b>", 
                styles['BodyText']
            ...
            elements.append(Paragraph(
                "Take a few minutes each day to sit quietly with your thoughts. "
                "Notice what arises within you without judgment. "
                "Consider journaling your observations to deepen your self-awareness.",
                styles['BodyText']
            ))

...
- If a mandatory category fail is what's driving a Poor grade, ALSO add 2-3 plain factual sentences noting: this is a traditional pre-marital screening heuristic, not a predictor of relationship outcome or marital happiness; classical tradition itself documents dosha-cancellation/remedy provisions in some lineages, though this reading does not check for or apply any such cancellation (do not imply one was checked or ruled out); and long, happy marriages sharing this same flagged pattern are well documented and unremarkable. Fold this into the existing paragraph rather than adding a separate section.
